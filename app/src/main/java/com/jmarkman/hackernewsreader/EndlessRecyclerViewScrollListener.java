...
public abstract class EndlessRecyclerViewScrollListener extends RecyclerView.OnScrollListener
{
    ...
    public void onScrolled(RecyclerView view, int dx, int dy)
    {
        ...
        // should be reset back to its initial state
        ...
        // conclude that it has finished loading and update the current page number and total
        // item count
        ...
        // and need to load more data. If we do need to load more, we execute onLoadMore to fetch
        // the data. The threshold should reflect how many total columns there are, too
